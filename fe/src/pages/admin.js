...
export default function AdminDashboard() {
  ...
  const fetchUsers = async (token) => {
    ...
    try {
      ...
      const response = await axios.get(`${API_URL}/admin/users?limit=1000`, { headers });
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">User Management & System Control</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-100 text-sm font-medium mb-1">Administrators</p>
                    ...
                    <tr key={user._id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <select
                          ...
                          className={`px-3 py-1.5 text-xs font-semibold rounded-full border-0 cursor-pointer transition-colors ${user.role === 'admin'
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        <button
                          ...
                          disabled={user.username === 'admin'}
                          className={`inline-flex items-center gap-1 px-3 py-1.5 rounded-lg font-semibold transition-colors ${user.username === 'admin'
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-gray-700 mb-2">
                Are you sure you want to delete user <strong className="text-gray-900">{userToDelete.username}</strong>?
              </p>
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-6">
                <p className="text-sm text-yellow-800">
                  ⚠️ This will permanently delete all their queries and data. This action cannot be undone.
                </p>
              </div>
